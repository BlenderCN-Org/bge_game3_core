...
"VEH_HANDBRAKE":     input.KeyBase("212.V",  "SPACEKEY",       "Vehicle Handbrake",     JOYBUTTON=12),
"VEH_FIRE":          input.KeyBase("213.V",  "EKEY",           "Vehicle Weapon Fire",   JOYBUTTON=10),
...
"SHEATH":            input.KeyBase("305.W",  "XKEY",           "Sheath Weapon"),
